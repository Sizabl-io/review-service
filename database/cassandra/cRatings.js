...
const reviewGenerator = async (index) => {
  ...
  for (var i = 0; i < doc_size; i++) {
    records.push({
      ...
      one_star_rating: Math.floor(Math.random()*(100)) / 10,
      two_star_rating: Math.floor(Math.random()*(100)) / 10,
      three_star_rating: Math.floor(Math.random()*(100)) / 10,
      four_star_rating: Math.floor(Math.random()*(100)) / 10,
      five_star_rating: Math.floor(Math.random()*(100)) / 10
    })
  }
